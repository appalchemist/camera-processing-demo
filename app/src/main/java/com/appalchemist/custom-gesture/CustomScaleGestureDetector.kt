...
class CustomScaleGestureDetector(private val mListener: OnScaleGestureListener) {
    /**
    ...
    private var mCurrSpanVector = Vector2D()
    ...
    private fun setContext(view: View, curr: MotionEvent) {
        ...
        if (prevIndex0 < 0 || prevIndex1 < 0 || currIndex0 < 0 || currIndex1 < 0) {
            ...
            Log.e(this::class.java.simpleName, "Invalid MotionEvent stream detected.", Throwable())
